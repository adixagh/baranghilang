...
<div class="row">
  <div class="col-md-4 col-md-offset-8">
    <form action="barangtemuan.php" method="get">
      <div class="input-group pull-right">
        <input class="form-control" type="search" placeholder="Cari Barang" aria-label="Search" name="caribarang">
  ...
  if (isset($_GET['caribarang'])) {
    ...
    $QueryBarang = mysqli_query($koneksi, "SELECT * FROM tbl_barangtemuan p 
  ...
  ?>
    <div class="col-sm-6 col-md-4 product">
      ...
      <div class="content">
        ...
        <a href="detailt.php?id_barangtemuan=<?php echo $show['id_barangtemuan']; ?>" class="btn btn-primary btn-rounded btn-sm"> <i class="ion-android-open"></i> Details</a>
