        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="adminweb.php?module=baranghilang" aria-expanded="false">
                            <i class="fa fa-bars menu-icon"></i><span class="nav-text">Barang Hilang</span>
                        </a>
                    </li>
                    <li>
                        <a href="adminweb.php?module=barangtemuan" aria-expanded="false">
                            <i class="fa fa-bars menu-icon"></i><span class="nav-text">Barang Temuan</span>
                        </a>
                    </li>
                    <li>
