            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <?php
                                $kueriKategori = mysqli_query($koneksi, "SELECT * FROM tbl_barangtemuan p INNER JOIN tbl_kategori k on p.id_kategori = k.id_kategori");
                    ...
                    <div class="box-footer clearfix">
                        <a href="adminweb.php?module=tambah_barangtemuan" class="btn btn-primary ml-1 btn-flat pull-left">Tambah Barang</a>
...
<div class="modal fade" id="laporan">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="../module/barangtemuan/aksi_laporan.php" method="post">
