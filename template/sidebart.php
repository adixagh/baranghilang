    ...
    <div class="container tags">
        ...
        <?php
          ...
          <label class="btn btn-default btn-xs active">
            <input type="radio" name="options" id="option1" checked> <a href="kategorit.php?id=<?= $show['id_kategori']; ?>"><?= $show['nama_kategori']; ?></a>
          </label>
        ...
        <div class="col-sm-3 filter">
          <div class="item">
              <div class="title">
                  ...
                  <a href="barangtemuan.php" data-action="clear"> <i class="ion-ios-trash-outline"></i> Clear</a>
              ...
              ?>
                <div class="checkbox-group" data-status="inactive">
                    ...
                    <div class="label" data-value="Laptops"><a href="kategorit.php?id=<?= $show['id_kategori']; ?>"><?= $show['nama_kategori']; ?></a></div>
