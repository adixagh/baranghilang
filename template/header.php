    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li class="<?php echo ($page == 'index') ? 'active' : ''; ?>"> <a class="active" href="index.php">Home</a></li>
          <li class="<?php echo ($page == 'baranghilang') ? 'active' : ''; ?>"> <a class="active" href="baranghilang.php">Barang Hilang</a></li>
          <li class="<?php echo ($page == 'barang_temuan') ? 'active' : ''; ?>"> <a class="active" href="barangtemuan.php">Barang Temuan</a></li>
